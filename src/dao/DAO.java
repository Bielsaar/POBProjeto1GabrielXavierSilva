...
public abstract class DAO<T> implements DAOInterface<T> {
	...
	public static void abrirBancoLocal(){		
		...
		config.common().objectClass(IncrementalId.class).cascadeOnUpdate(true);
		config.common().objectClass(IncrementalId.class).cascadeOnDelete(false);
		config.common().objectClass(IncrementalId.class).cascadeOnActivate(true);
		// 		indices
		...
		config.common().objectClass(IncrementalId.class).objectField("incId").indexed(true); 
